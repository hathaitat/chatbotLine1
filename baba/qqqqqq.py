...
#   for item in xmldoc.findall("./sensortree/nodes/group/probenode/group/device/sensor/[status='Down (Acknowledged)']"):
  for item in xmldoc.findall("./sensortree/nodes/group/probenode/group/device/sensor/[status='Up']"):
    ...
    #########################
    # url = 'https://servicedesk.officemate.co.th/sdpapi/request?OPERATION_NAME=ADD_REQUEST&TECHNICIAN_KEY=8A2D71B6-473C-4BBF-91C9-00493F31902B&INPUT_DATA=<Operation><Details><requester>PRTG</requester><subject>'+str(id)+' Status: Down</subject><description>'+str(name)+'</description><priority>Hight</priority><level>Tier 2</level><requesttemplate>Default Request</requesttemplate><impact>Affects Business</impact><urgency>Hight</urgency></Details></Operation>'
    # headers = {
    #         'Content-Type': 'application/xml; charset=UTF-8',
    #         }  
    # p = requests.post(url, headers=headers)
...
# https://servicedesk.officemate.co.th/sdpapi/request/111?OPERATION_NAME=ADD_REQUEST&TECHNICIAN_KEY=8A2D71B6-473C-4BBF-91C9-00493F31902B&INPUT_DATA=<Operation>

# <Details>

# <requester>Howard Stern</requester>

# <subject>The subject of the request</subject>

# <description>The description of the request</description>
...
# <impact>Affects Business</impact>
